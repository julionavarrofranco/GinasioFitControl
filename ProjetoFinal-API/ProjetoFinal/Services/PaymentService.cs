...
namespace ProjetoFinal.Services
{
    public class PaymentService : IPaymentService
    {
        ...
        //Criar pagamento com base na subscrição do membro, bloqueando pagamentos retroativos e garantindo que não haja pagamentos duplicados para o mesmo período. 
        public async Task CreatePaymentAsync(PaymentDto request)
        {
            var now = DateTime.UtcNow;
            const int dia_vencimento = 8;
            ...
            var mesReferente = now.Day > dia_vencimento
                ? primeiroDiaMesAtual.AddMonths(1)
                : primeiroDiaMesAtual;
            ...
            var dataPagamento = now > dataPagamentoPlaneada ? now : dataPagamentoPlaneada;
            ...
            var pagamento = new Pagamento
            {
                ...
                ValorPago = subscricao.Preco,
                MetodoPagamento = request.MetodoPagamento,
                EstadoPagamento = dataPagamento <= now
        ...
        // Atualizar pagamento, permitindo alterar o valor pago, método de pagamento e estado do pagamento, mas bloqueando alterações que possam criar inconsistências (ex: marcar um pagamento como "Pago" sem data de pagamento).
        ...
        // Permitir ativar/desativar um pagamento, onde desativar um pagamento significa que ele não deve ser considerado nas listagens ativas e nos cálculos de receita, mas ainda deve permanecer no banco de dados para fins históricos.
        ...
        //Listar pagamentos por estado (ativo/inativo)
        ...
        // Listar pagamentos por estado do pagamento 
        ...
        // método para calcular receita mensal, considerando apenas pagamentos ativos e com estado "Pago". (para dashboard)
        ...
        //método para verificar se já existe um pagamento ativo para o mesmo membro e período, considerando o tipo de subscrição (mensal, trimestral, anual) para evitar pagamentos duplicados.
