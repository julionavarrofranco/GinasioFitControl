...
namespace ProjetoFinal.Services
{
    public class ExerciseService: IExerciseService
    {
        ...
        // Altera o status ativo/inativo do exercício
        public async Task ChangeExerciseActiveStatusAsync(int idExercicio, bool ativo)
        {
            ...
            // Se o status já for o mesmo, não há alteração
        ...
        // Retorna os exercícios filtrados por status ativo/inativo, com ordenação opcional
        ...
        // Retorna os exercícios filtrados por grupo muscular, com ordenação opcional
        ...
        // Retorna os exercícios filtrados por nome (busca parcial - like), com ordenação opcional
