...
namespace ProjetoFinal.Services
{
    public class PhysicalEvaluationReservationService: IPhysicalEvaluationReservationService
    {
        ...
        // Permite criar uma nova reserva para avaliação física, garantindo que o membro não tem reservas ativas e que a data da reserva é válida (pelo menos 7 dias de antecedência).
        // Verifica também conflitos de horário com outras reservas.
        ...
        // Permite cancelar uma reserva ativa (estado Reservado) com pelo menos 7 dias de antecedência. Marca a data de cancelamento e desativa a reserva.
        ...
        // Permite confirmar a presença do membro para uma reserva ativa (estado Reservado). Apenas muda o estado para Presente, sem criar a avaliação física. A avaliação física será criada posteriormente (logo a seguir)
        ...
        // Marca a presença do membro e, se presente, cria a avaliação física associada. Se não presente, apenas marca como faltou.
        ...
        // Retorna todas as reservas ativas (estado Reservado) 
        ...
        // Retorna todas as reservas concluídas (Presente, Faltou ou Cancelado) para histórico
        ...
        // Retorna a reserva ativa (estado Reservado) de um membro
