...
namespace TTFWebsite.Services
{
    public class ApiService : IApiService
    {
        ...
        {
            var token = _httpContextAccessor.HttpContext?.User.FindFirst(JwtClaimType)?.Value;
        ...
        public async Task<TrainingPlanViewModel?> GetCurrentTrainingPlanAsync()
        {
            ...
            {
                Name = dto.Nome,
                CreatedBy = dto.NomeFuncionario ?? string.Empty,  
                CreatedDate = dto.DataCriacao,                    
        ...
        //método para extrair mensagem da API
