...
namespace FitControlAdmin
{
    public partial class MainWindow : Window
    {
        ...
        private async Task ShowSubscriptionManagement()
        {
            ...
            var isRececao = string.Equals(_userFuncao, "Rececao", StringComparison.OrdinalIgnoreCase);
            CreateSubscriptionButton.Visibility = isRececao ? Visibility.Collapsed : Visibility.Visible;
            SubscriptionsActionsColumn.Visibility = isRececao ? Visibility.Collapsed : Visibility.Visible;
